...
namespace Realm {
  ...
  class GenEventImpl;
	...
	: FabMessage(target, METADATA_REQUEST_MSGID, NULL)   { }
	...
	: FabMessage(target, METADATA_RESPONSE_MSGID, payload)   { }
	...
	: FabMessage(dest, METADATA_INVALIDATE_MSGID, NULL)   { }
	...
	: FabMessage(dest, METADATA_INVALIDATE_ACK_MSGID, NULL)   { }

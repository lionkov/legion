...
./runtests y -ll:exchange_server_host $EXCHANGE_HOST -ll:exchange_server_send_port $EXCHANGE_SEND -ll:exchange_server_recv_port $EXCHANGE_RECV -ll:num_nodes $NUM_NODES -ll:handlers $HANDLER_COUNT -ll:stacksize $STACK_SIZE &
